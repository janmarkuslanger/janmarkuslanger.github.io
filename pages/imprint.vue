<template>
    <div class="page">
        <ArticleElement>
            <TextElement title="Imprint">
                <p>Information in accordance with Section 5 TMG</p>
                <br><br>Deutschland<br>51789 Lindlar<br>
                <h2>Contact Information</h2>
                Telephone: 01716282738<br>E-Mail: <a href="mailto:jan-markus@gmx.de">jan-markus@gmx.de</a><br>Internet address: <a href="https://janmarkuslanger.github.io/" target="_blank">https://janmarkuslanger.github.io/</a><br><br>
                <h2>Disclaimer</h2>
...
import TextElement from '@/components/text-element.vue';
